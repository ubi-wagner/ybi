...
| --- | --- | ---: | --- | --- |
| 1 | **Drive AM invoice 10018 is entirely outside the period of performance.** Award ran to 4 Jan 2026; the invoice bills April 2026 service. | **37,593.90** | `constraint_result` **TERM fails**, Agreement §10.1 — *"37,593.90 invoiced after 04 Jan 2026"* | **Makes it worse.** Restating adds 16,537.56 to a claim already outside the term — **54,131.46** outside it. Restating does not fix this; a term extension or a re-dated claim does. |
